...
const tempMailCommand = async (m, Matrix) => {
    ...
    if (cmd === 'tempmail') {
        try {
            ...
            if (!genData.email) {
                m.reply('Yo, failed to generate temporary email.');
                await m.React("❌");
                return;
            }
                    ...
                    message: {
                        ...
                        interactiveMessage: proto.Message.InteractiveMessage.create({
                            body: proto.Message.InteractiveMessage.Body.create({
                                text: `Yo, check this out! Generated Temporary Email: ${tempEmail}`
                            }),
                            footer: proto.Message.InteractiveMessage.Footer.create({
                                text: "🔥 © Powered By AMERICA BOT 🇺🇲"
                            }),
            ...
            console.error("Yo, error processing your request:", error);
            m.reply('Yo, error processing your request.');
            await m.React("❌");
        }
        ...
        try {
            ...
            if (inboxData.messages && inboxData.messages.length > 0) {
                inboxMessages = 'Yo, check this out! Inbox Messages:\n\n';
                ...
                inboxMessages = 'Yo, check this out! No messages found in the inbox.';
            }
