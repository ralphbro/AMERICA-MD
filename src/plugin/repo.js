...
const handleRepoCommand = async (m, Matrix) => {
  const repoUrl = 'https://api.github.com/repos/andymrlit';
  try {
              ...
              buttons: [
                ...
                },
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://github.com/andymrlit/fork`
                  })
                },
                {
                  name: "cta_url",
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://chat.whatsapp.com/G7LUbQ1hEcc1vApJ0mBHAg`
                  })
                }
              ],
            }),
